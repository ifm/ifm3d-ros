...
docker build -t ifm3d-ros:noetic-x86_64 --rm --build-arg IFM3D_CLONE_REPO=$IFM3D_CLONE_REPO --build-arg IFM3D_ROS_CLONE_REPO=$IFM3D_ROS_CLONE_REPO -f Dockerfile .
