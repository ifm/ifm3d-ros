...
ifm3d_ros::CameraNodelet::onInit()
{
  ...
  this->extrinsics_pub_ =
    this->np_.advertise<ifm3d_ros_msgs::Extrinsics>("extrinsics", 1);
  NODELET_DEBUG_STREAM("after advertising the publishers");
  //---------------------
  // Advertised Services
  //---------------------
  this->dump_srv_ =
    this->np_.advertiseService<ifm3d_ros_msgs::Dump::Request, ifm3d_ros_msgs::Dump::Response>
    ("Dump", std::bind(&CameraNodelet::Dump, this,
                       std::placeholders::_1,
                       std::placeholders::_2));

  this->config_srv_ =
    this->np_.advertiseService<ifm3d_ros_msgs::Config::Request, ifm3d_ros_msgs::Config::Response>
    ("Config", std::bind(&CameraNodelet::Config, this,
                         std::placeholders::_1,
                         std::placeholders::_2));

  this->trigger_srv_ =
    this->np_.advertiseService<ifm3d_ros_msgs::Trigger::Request,
                               ifm3d_ros_msgs::Trigger::Response>
    ("Trigger", std::bind(&CameraNodelet::Trigger, this,
                          std::placeholders::_1,
                          std::placeholders::_2));

  this->soft_off_srv_ =
    this->np_.advertiseService<ifm3d_ros_msgs::SoftOff::Request,
                               ifm3d_ros_msgs::SoftOff::Response>
    ("SoftOff", std::bind(&CameraNodelet::SoftOff, this,
                          std::placeholders::_1,
                          std::placeholders::_2));

  this->soft_on_srv_ =
    this->np_.advertiseService<ifm3d_ros_msgs::SoftOn::Request,
                               ifm3d_ros_msgs::SoftOn::Response>
...
bool
ifm3d_ros::CameraNodelet::Dump(ifm3d_ros_msgs::Dump::Request& req,
...
bool
ifm3d_ros::CameraNodelet::Config(ifm3d_ros_msgs::Config::Request& req,
...
bool
ifm3d_ros::CameraNodelet::Trigger(ifm3d_ros_msgs::Trigger::Request& req,
...
bool
ifm3d_ros::CameraNodelet::SoftOff(ifm3d_ros_msgs::SoftOff::Request& req,
...
// we keep this in to possibly keep it comparable / interoperable with the ROS wrappers for other ifm cameras
bool
ifm3d_ros::CameraNodelet::SoftOn(ifm3d_ros_msgs::SoftOn::Request& req,
